...
<html>
	...
	<fieldset align="center">
        <legend><p align="center"><font size="+2"><label><strong> : تواصل معنا</strong></label></font></p></legend>
        <p align="center"><label><strong>رقم الهاتف : 0123456789</strong></label></p>
        <br>
			<p align="center">
				<a href="mailto:radebr@yandex.ru" target="_blank"><strong>radebr@yandex.ru</strong></a><strong> :البريد الإلكتروني</strong>
				</p>
				<br>
				<p align="center">
				<a href="https://t.me/crnohd" target="_blank"><strong>@crnohd</strong></a><strong> :تيلغرام</strong>
			</p>
		<br>
    </fieldset>
    <br>
